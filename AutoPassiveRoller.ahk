...
; August 8/21
; Riot changed sorcery icon, changed script to recgonize slow but steady and sorcery
...
Gui, Show, w633 h302, Labs Auto Selector GUI August 8/21 Edition

if((A_ScreenWidth = 1920) && (A_ScreenHeight = 1080))
	Resolution:=1
else if((A_ScreenWidth = 2560) && (A_ScreenHeight = 1440))
	Resolution:=2
else if((A_ScreenWidth = 1366) && (A_ScreenHeight = 768))
	Resolution:=3
else if((A_ScreenWidth = 1600) && (A_ScreenHeight = 900))
	Resolution:=4
else {
	...
	GuiControl, Choose, Resolution, |%Resolution%
